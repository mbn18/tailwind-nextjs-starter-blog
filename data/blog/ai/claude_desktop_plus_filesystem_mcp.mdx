...
### Prerequisite:
* Install [Claude Desktop](https://claude.ai/download) - currently not available on Linux 😡

### Setup

Open `Claude Desktop` and go to settings (on mac cmd+,)

On the left side click **Extensions** and then click **Filesystem**
...
1.  **Root Directory:** The operational root is `/Users/miki/Projects/SandBox/sample-api`. All relative paths originate from this location.
...
* Assume all files are under the `/Users/miki/Projects/SandBox/sample-api` directory and it is the root for any relative path.
